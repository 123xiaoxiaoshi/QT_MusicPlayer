...
void Login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->handoffMain(); break;
        case 2: _t->backMain(); break;
        case 3: _t->thisShow(); break;
        default: ;
        }
        ...
        {
            using _t = void (Login::*)();
            if (_t _q_method = &Login::handoff; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Login::*)();
            if (_t _q_method = &Login::handoffMain; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
